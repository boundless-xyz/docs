...
<Warning>
By default, the parameters are chosen to maximize the chance that a request is fulfilled.
They use relaxed timeouts, dynamic market pricing, and recommended collateral.
You should only change them if you really need to.
</Warning>
...
<Note>
The SDK will show a warning if any overridden parameter may reduce the chance of fulfillment.
</Note>
